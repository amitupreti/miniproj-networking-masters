...
df['cases per 1 mil'] = df['cases']/df['popData2019']*1000000
df['deaths per 1 mil'] = df['deaths']/df['popData2019']*1000000
...
layout = html.Div([
    dbc.Container([
        dbc.Row([
            dbc.Col(dbc.Card(html.H4(children='Data Source: European Centre for Disease Prevention and Control',
...
# for some reason, font colour remains black if using the color option
    ...
    dbc.Row([
        dbc.Col(html.H5(children=f'Last update: {UPDATED_DATE}', className="text-center"),
    ...
    dcc.Dropdown(
        ...
        value=['Canada', 'United_States_of_America'],
        multi=True,
